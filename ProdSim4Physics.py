...
parser.add_argument("-output_sclio", help="Output file path", required=True)
...
#Sample = "Zbb"
#output_sclio = "/eos/home-j/jandrea/SampleFCCee_HNL/"
os.system("mkdir "+args.output_sclio+"/"+args.Sample+"/")
#inputFiles_ = "/eos/home-j/jandrea/SampleFCCee_HNL/"+Zbb+"/tag_1_pythia8_events.hepmc"
inputFiles_ = args.inputFiles+"/"+args.Sample+"/tag_1_pythia8_events.hepmc"
...
for ijob in range(N_jobs-1):
   ...
   with open(bash_file, "w") as file:
      ...
      arguments = " --compactFile $LCGEO/compact/FCCee/CLD/compact/FCCee_o2_v02/FCCee_o2_v02.xml --inputFiles " + inputFiles_ + " --numberOfEvents " + args.Nevts_per_job + " --skipNEvents " + str(skip_events) + " --steeringFile fcc_steer.py " + " --outputFile  " + outputfileName
      command = "ddsim " + arguments
      file.write(command+"\n")
      file.write("cp "+ outputfileName + "  " + args.output_sclio+"/"+args.Sample+"/." +"\n")
      file.close()
